package de.otto.mytoys.navigation.repository;
...
public class NaviagationRepo {

    public NavigationEntry createSections() {
    ...
    private List<NavigationEntry> createSectionNodes() {
        ...
        return Collections.singletonList(alterNode);
    }
